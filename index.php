...
<body>
   ...
   <div class="container">
    	<div class="other-content">Need to find free images/no copyright And if we can keep the slider</div>
    ...
    <article>
        <div class="main_page_txt_div">
            ...
            <h1>IF IT LAGS ON MAIN PAGE CONSIDER REMOVING  THE image slider </h1>
        </div>
    </article>
